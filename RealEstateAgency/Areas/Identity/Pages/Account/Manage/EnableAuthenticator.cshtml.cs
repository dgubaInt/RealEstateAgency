...
namespace RealEstateAgencyMVC.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(7, ErrorMessageResourceType = typeof(UILabel), ErrorMessageResourceName = nameof(UILabel.LengthError), MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("Input.Code", UILabel.VerificationCodeIsInvalid);
                await LoadSharedKeyAndQrCodeUriAsync(user);
                return Page();
            }
            ...
            StatusMessage = UILabel.AuthenticatorAppVerified;
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(AgentUser user)
        {
