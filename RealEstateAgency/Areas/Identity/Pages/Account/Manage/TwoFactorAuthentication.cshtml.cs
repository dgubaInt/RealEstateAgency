...
namespace RealEstateAgencyMVC.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<AgentUser> userManager, SignInManager<AgentUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = UILabel.BrowserHasBeenForgottenDetails;
